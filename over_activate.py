...
# Flask
over_activate = Blueprint('over_activate', __name__, static_folder='static', template_folder='templates')

@over_activate.route('/over_activate', methods=['POST'])
def Index():
...
# Determine user action
	if request.form['response_input'] == DONE:
